...
function Hero() {
    return (
        <>
            <section className="py-16 px-20 bg-gradient-to-r from-white via-white to-[#CDD1EE]">
                <div className="flex flex-col gap-6 md:flex-row justify-between  items-center">
                    <div className="space-y-5">
                        ...
                        <button className="px-8 py-3 rounded-md text-white bg-[#354Ac5] hover:bg-blue-800 font-semibold"><span className="text-[#FFEB3A]">Ultimate</span> Placement Solution</button>
                    </div>
                    {/* hero section image */}
                    <div>
