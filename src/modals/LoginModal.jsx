            ...
            <div className="fixed bg-black/80 inset-0 bg-opacity-70 flex justify-center items-center z-50">
                ...
                <div className="p-8 shadow w-[80%] max-w-md bg-black text-white relative">
                    ...
                    <form className="space-y-5">
                        <div>
                            <label className="block mb-1 text-sm"  htmlFor="">What's your e-mail</label>
                            <input type="email" placeholder="Email" className="w-full px-4 py-2 bg-neutral-800  outline-none  placeholder:text-neutral-500 placeholder:text-xs" />
                        </div>
                        <div>
                            <label className="block mb-1 text-sm" htmlFor="">Your password</label>
