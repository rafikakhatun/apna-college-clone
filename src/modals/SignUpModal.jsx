                ...
                <div className="bg-black text-white p-8  w-[90%] max-w-md relative">
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Name" className="w-full px-4 py-3 bg-neutral-800  outline-none  placeholder:text-neutral-500 placeholder:text-xs" />
                        </div>

                        {/* Email */}
                        <div>
                            <label className="block mb-2 text-sm">What's your e-mail?</label>
                            <input type="email" placeholder="E-mail" className="w-full px-4 py-3 bg-neutral-800 outline-none placeholder:text-neutral-500 placeholder:text-xs" />
                        </div>

                        {/* Password */}
                        <div>
                            <label className="block text-sm mb-2">Your password?</label>
                            <input type="password" placeholder="Password" className="w-full px-3 py-2 bg-neutral-800 outline-none placeholder:text-neutral-500 placeholder:text-xs" />
                        </div>

                        {/* Phone Number */}
                        <div>
                            <label className="block mb-2 text-sm">Phone Number</label>
                            <input type="tel" placeholder="98xxxxxxxx" className="w-full px-4 py-3 bg-neutral-800 outline-none placeholder:text-neutral-500 placeholder:text-xs" />
                        </div>
